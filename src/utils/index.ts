...
const translateCondition = (code: number) => {
  ...
  else if (code == 1003) return "LightCloud";
  else if ([1006, 1009, 1030, 1135, 1147].includes(code)) return "HeavyCloud";
  else if (code == 1237) return "Hail";
  else if (code == 1195) return "HeavyRain";
  else if ([1180, 1183, 1186, 1189].includes(code)) return "LightRain";
  else if ([1186, 1063, 1192, 1240, 1243, 1246, 1249, 1252, 1255, 1258, 1261, 1264].includes(code)) return "Shower";
  else if ([1069, 1198, 1201, 1204, 1207].includes(code)) return "Sleet";
  else if ([1066, 1072, 1114, 1117, 1150, 1153, 1168, 1171, 1210, 1213, 1216, 1219, 1222, 1225].includes(code))
    return "Snow";
  else if ([1087, 1273, 1276, 1279, 1282].includes(code)) return "Thunderstorm";
  else return "Clear";
};
...
const WEATHER_API_KEY = "c5009091fd1a4af384b125758221612";

export { formatDate, translateCondition, setNewCoords, checkIfTomorrow, DEFAULTDATA,WEATHER_API_KEY };
